...
# -----------------------------------------------
## -----------------------------------------------
# 3 | Mini bar plots of subterms for each theme
# -----------------------------------------------
...
def plot_subterms_bar(enr_df, theme_name, path_prefix, output_folder):
    ...
    plt.xlabel("–log$_{10}$(p-value)", size=10)
...
for path in GENE_FILES:
    ...
    # Save theme summary table and bar plot
